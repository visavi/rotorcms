	...
	case '1':
		...
		if (!empty($agree)) {
			...
			if (version_compare(PHP_VERSION, '5.4.0') > 0) {
				echo '<img src="../images/img/plus.gif" alt="image" /> Версия PHP 5.4.0 и выше: <b><span style="color:#00cc00">ОК</span></b> (Версия ' . phpversion() . ')<br />';
			} else {
				echo '<img src="../images/img/minus.gif" alt="image" /> Версия PHP 5.4.0 и выше: <b><span style="color:#ff0000">Ошибка</span></b>  (Версия ' . phpversion() . ')<br />';
				$error_critical = 1;
			}
